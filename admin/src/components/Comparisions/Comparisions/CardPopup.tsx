          ...
          >
            ...
            >
              ...
              <div
                ...
                className="NoteCanTBeUndoneLaterAndYouAreFreeToEditThisComparisionStackInsteadOfDeletingItFull flex-1 justify-start text-neutral-50 text-sm font-normal font-['Poppins']"
              >
                Note: Can’t be undone later! and you are free to edit this Comparision
            ...
            {confirmOpen ? (
              ...
              <>
                ...
                <div
                  ...
                  onClick={(): void => {
                    if (id) {
                      void Promise.resolve(navigate(`/updateComparision/${id}`));
                    }
                  }}
                >
                  <div

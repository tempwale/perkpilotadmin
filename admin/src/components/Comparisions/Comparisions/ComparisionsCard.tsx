...
export default function ComparisionCard({
  ...
  logoComponent = <div />,
  verified = true,
  ComparisionType = "Hot Comparision",
  features = [
    "Unlimited Blocks",
    "Team Collaboration",
    "Advance Permissions",
  ...
  return (
    <div>
      <div className="flex justify-center items-center w-full">
        ...
        >
          <div
            data-layer="Customize Comparision Card?"
            className="CustomizeComparisionCard justify-start text-neutral-50 text-sm font-medium font-['Plus_Jakarta_Sans'] underline leading-[21px]"
            onClick={openModal}
          >
